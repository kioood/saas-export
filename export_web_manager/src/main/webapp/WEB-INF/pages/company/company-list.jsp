    ...
    <div class="box box-primary">
                ...
                <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <button type="button" class="btn bg-olive btn-xs" onclick='location.href="${path}/company/toUpdate.do?id=${item.id}"'>编辑</button>
                        </td>
                    </tr>
                    </c:forEach>
                    </tbody>
        ...
        <div class="box-footer">
            ...
            <jsp:include page="../common/page.jsp">
                <jsp:param value="${path}/company/ms.do" name="pageUrl"/>
            </jsp:include>
        </div>
